...
public class Task02 {
    public static String task02(int number) {
        if (number >= 0) {
            String second1 = String.valueOf(number % 60 % 10);
            String second2 = String.valueOf(number % 60 / 10 % 10);
            String minute1 = String.valueOf(number / 60 % 60 % 10);
            String minute2 = String.valueOf(number / 60 % 60 / 10 % 10);
            String hour = String.valueOf(number / 3600 % 24);
            return (hour + ":" + minute2 + minute1 + ":" + second2 + second1);
        }
        return "error";
    }
}
